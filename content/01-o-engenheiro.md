...
Ele tem capacidade para fazer isso. Mas ainda faltam informações para decidir **como** fazer.

## O que você teria vontade de contar a ele?

Pense por alguns minutos antes de continuar.

Você provavelmente falaria sobre coisas como:

- qual problema o produto precisa resolver;
- quem usa a funcionalidade;
- quais sistemas já existem;
- quais padrões a equipe segue;
- quais tecnologias estão disponíveis;
- o que não pode ser alterado;
- quais riscos são importantes;
- como uma solução será considerada correta;
- quem precisa aprovar a mudança.
...
É tentador chamar o modelo de linguagem de “agente”. Para este workshop, vamos separar as duas coisas.
